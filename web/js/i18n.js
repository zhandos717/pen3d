...
const KK = {
  ...
  // история версий
  'История версий':'Нұсқалар тарихы', 'Скрыть историю':'Тарихты жасыру',
  'пока нет ни одной версии':'әзірге бірде-бір нұсқа жоқ',
  'история недоступна':'тарих қолжетімсіз', 'авто':'авто', 'вручную':'қолмен',
  'перед откатом':'қайтару алдында', 'сцена возвращена на ':'сахна қайтарылды: ',
  'нет такой версии':'мұндай нұсқа жоқ',
  // подгонка камеры
  '— виды · ':'— көріністер · ',
  '— приблизить к детали · ':'— бөлшекке жақындау · ',
  'приближено: ':'жақындатылды: ',
  'приближено к детали':'бөлшекке жақындатылды',
  'нечего приближать':'жақындататын ештеңе жоқ',
  'не определён':'анықталмады',
  'катушка':'катушка',
  'ошибка':'қате',
  'Сгруппировать':'Топтастыру',
  'выбери любую часть детали':'бөлшектің кез келген бөлігін таңда',
  'эта фигура ни с чем не соединена — двигать нечего вместе':'бұл фигура ешнәрсемен байланыспаған',
  'связано тел: ':'байланысты дене: ',
  ' · теперь двигаются вместе':' · енді бірге жылжиды',
  'связать деталь: все касающиеся тела поедут вместе':'бөлшекті байланыстыру: жанасқан денелер бірге жылжиды',

  'пластина':'пластина',
  'текстурированная / HDT':'текстуралы / HDT',
  'высокотемпературная':'жоғары температуралы',
  'инженерная':'инженерлік',
  'холодная':'суық',
  'по центру':'ортаға',
  'на стол':'үстелге',
  'связать':'байланыстыру',
  'Поставить по центру детали':'Бөлшектің ортасына қою',
  'Посадить деталь на стол':'Бөлшекті үстелге қондыру',
  'Связать деталь: касающиеся тела поедут вместе':'Бөлшекті байланыстыру: жанасқан денелер бірге жылжиды',
  'оставить общее':'ортақ бөлікті қалдыру',
  'Зеркало':'Айна',
  'Массив':'Массив',
  'по X':'X бойынша',
  'по Y':'Y бойынша',
  'в ряд':'қатармен',
  'по кругу':'шеңбер бойымен',
  'штук':'дана',
  'отразить фигуру или всю группу':'фигураны немесе бүкіл топты айналдыру',
  'размножить фигуру или группу':'фигураны немесе топты көбейту',
  'от детали останется только то, что попало внутрь этой фигуры':'бөлшектен тек осы фигураның ішіне түскені қалады',
  'Скруглённая площадка':'Дөңгелетілген алаң',
  'радиус угла, мм':'бұрыш радиусы, мм',
  'прямоугольник со скруглёнными углами':'бұрыштары дөңгелетілген тіктөртбұрыш',
  'готовлю модель':'модельді дайындап жатырмын',
  'готовлю…':'дайындалуда…'
...
const EN = {
  ...
  // история версий
  'История версий':'Version history', 'Скрыть историю':'Hide history',
  'пока нет ни одной версии':'no versions yet',
  'история недоступна':'history unavailable', 'авто':'auto', 'вручную':'manual',
  'перед откатом':'before rollback', 'сцена возвращена на ':'scene restored to ',
  'нет такой версии':'no such version',
  // подгонка камеры
  '— виды · ':'— views · ',
  '— приблизить к детали · ':'— zoom to part · ',
  'приближено: ':'zoomed to: ',
  'приближено к детали':'zoomed to the part',
  'нечего приближать':'nothing to zoom to',
  'Сгруппировать':'Group',
  'выбери любую часть детали':'select any part of the piece',
  'эта фигура ни с чем не соединена — двигать нечего вместе':'this shape touches nothing — nothing to move with it',
  'связано тел: ':'bodies linked: ',
  ' · теперь двигаются вместе':' · they move together now',
  'связать деталь: все касающиеся тела поедут вместе':'link the piece: touching bodies move together',
  'по центру':'center',
  'на стол':'to plate',
  'связать':'link',
  'Поставить по центру детали':'Center inside the part',
  'Посадить деталь на стол':'Drop the part onto the plate',
  'Связать деталь: касающиеся тела поедут вместе':'Link the part: touching bodies move together',
  'оставить общее':'keep common',
  'Зеркало':'Mirror',
  'Массив':'Array',
  'по X':'along X',
  'по Y':'along Y',
  ...
  'штук':'count',
  'отразить фигуру или всю группу':'mirror the shape or the whole group',
  'размножить фигуру или группу':'repeat the shape or the group',
  'от детали останется только то, что попало внутрь этой фигуры':'only what falls inside this shape is kept',
  'Скруглённая площадка':'Rounded plate',
  'радиус угла, мм':'corner radius, mm',
  'прямоугольник со скруглёнными углами':'rectangle with rounded corners',
  'готовлю модель':'preparing the model',
  'готовлю…':'preparing…'
